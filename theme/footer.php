...
<div id="backtotop">
    ...
    width="50px" height="50px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
      <path stroke-width="1px" id="arrow-28-icon" fill="#29e" transform="rotate(-90 256,256)" d="M90,256c0,91.755,74.258,166,166,166c91.755,0,166-74.259,166-166c0-91.755-74.258-166-166-166
