			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						texts.filters,
						' ',
						_react2.default.createElement('i', { className: 'ion-plus', 'data-jsx': 4102458832
						})
					),
					_react2.default.createElement(
						'div',
						{ className: filterContainerStyle, 'data-jsx': 4102458832
						},
						...
						_react2.default.createElement(
							'div',
							{ className: 'col-lg-3', 'data-jsx': 4102458832
							},
							_react2.default.createElement(
								'h5',
								{ className: 'filters-title', 'data-jsx': 4102458832
								},
								texts.products
							),
				...
				_react2.default.createElement(
					'div',
					{ className: 'col-lg-9', 'data-jsx': 4102458832
					},
					_react2.default.createElement(
						'div',
						{ className: 'projects', 'data-jsx': 4102458832
						},
						projects.length > 0 ? projects.map(function (project) {
							return _react2.default.createElement(
								'div',
								{ key: project.id, className: 'col-lg-4 col-md-6 project-item', 'data-jsx': 4102458832
								},
								_react2.default.createElement(_item2.default, { project: project })
							);
						}) : _react2.default.createElement(
							'div',
							{ className: 'empty-value', 'data-jsx': 4102458832
							},
							_react2.default.createElement(
								'h4',
								{
					...
					projects.length > 0 && _react2.default.createElement(
						'a',
						{ href: '#', onClick: this.paginate, className: 'pagination-btn', 'data-jsx': 4102458832
						},
						_react2.default.createElement(
							'span',
							{
				...
				_react2.default.createElement(_style2.default, {
					styleId: 4102458832,
					css: '.projects[data-jsx="4102458832"]{padding:0;margin:20px 0;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column}.pagination-btn[data-jsx="4102458832"]{float:right;margin:0 40px 20px 0;color:#039ED8;font-size:20px}.pagination-btn[data-jsx="4102458832"] span[data-jsx="4102458832"]{display:block}.project-item[data-jsx="4102458832"]{padding:5px}.empty-value[data-jsx="4102458832"]{height:100px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex:1;-ms-flex:1;flex:1;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.empty-value[data-jsx="4102458832"] h4[data-jsx="4102458832"]{font-size:17px;color:#039ED8}.filters-title[data-jsx="4102458832"]{font-size:15px;color:#039ED8}.filters[data-jsx="4102458832"]{width:100%;background:#fff;box-shadow:0 10px 10px rgba(0,0,0,.1);display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;padding-top:20px;-webkit-transition:.3s ease;transition:.3s ease}.filters--in-bound[data-jsx="4102458832"]{position:fixed;left:0;right:0;top:80px;z-index:100}.filters__toggle[data-jsx="4102458832"]{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-self:flex-end;-ms-flex-item-align:flex-end;align-self:flex-end;cursor:pointer;border:none;background:transparent;font-size:15px;color:#039ED8;margin-bottom:20px;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;outline:none}.filters__toggle[data-jsx="4102458832"] i[data-jsx="4102458832"]{padding:0 20px}.filters__toggle--open[data-jsx="4102458832"] i[data-jsx="4102458832"]::before{-webkit-transform:rotate(45deg);-ms-transform:rotate(45deg);transform:rotate(45deg)}.filters-container[data-jsx="4102458832"]{display:none}.filters-container--open[data-jsx="4102458832"]{display:block;padding-bottom:20px}@media (min-width:1024px){.projects[data-jsx="4102458832"]{-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row}.filters[data-jsx="4102458832"]{display:initial;box-shadow:none;background:transparent}.filters-container[data-jsx="4102458832"]{display:block}.filters__toggle[data-jsx="4102458832"]{display:none}}'
				})
			);
		}
	}]);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						texts.filters,
						' ',
						_react2.default.createElement('i', { className: 'ion-plus', 'data-jsx': 1593199046
						})
					),
					_react2.default.createElement(
						'div',
						{ className: filterContainerStyle, 'data-jsx': 1593199046
						},
						_react2.default.createElement(
							'div',
							{ className: 'col-md-3', 'data-jsx': 1593199046
							},
				...
				_react2.default.createElement(
					'div',
					{ className: 'col-sm-9', 'data-jsx': 1593199046
					},
					_react2.default.createElement(
						'div',
						{ className: 'products', 'data-jsx': 1593199046
						},
						products.length > 0 ? products.map(function (product) {
							return _react2.default.createElement(
								'div',
								{ className: 'col-md-4 product-item', 'data-jsx': 1593199046
								},
								_react2.default.createElement(_item2.default, product)
							);
						}) : _react2.default.createElement(
							'div',
							{ className: 'empty-value', 'data-jsx': 1593199046
							},
							_react2.default.createElement(
								'h4',
								{
					...
					products.length > 0 && !empty && _react2.default.createElement(
						'a',
						{ href: '#', onClick: this.paginate, className: 'pagination-btn', 'data-jsx': 1593199046
						},
						_react2.default.createElement(
							'span',
							{
				...
				_react2.default.createElement(_style2.default, {
					styleId: 1593199046,
					css: '.products[data-jsx="1593199046"]{padding:0px}.filters[data-jsx="1593199046"]{width:100%;background:#fff;box-shadow:0 10px 10px rgba(0,0,0,.1);display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;padding-top:20px;-webkit-transition:.3s ease;transition:.3s ease}.filters--in-bound[data-jsx="1593199046"]{position:fixed;left:0;right:0;top:80px;z-index:100}.filters__toggle[data-jsx="1593199046"]{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-self:flex-end;-ms-flex-item-align:flex-end;align-self:flex-end;cursor:pointer;border:none;background:transparent;font-size:15px;color:#039ED8;margin-bottom:20px;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;outline:none}.filters__toggle[data-jsx="1593199046"] i[data-jsx="1593199046"]{padding:0 20px}.filters__toggle--open[data-jsx="1593199046"] i[data-jsx="1593199046"]::before{-webkit-transform:rotate(45deg);-ms-transform:rotate(45deg);transform:rotate(45deg)}.filters-container[data-jsx="1593199046"]{display:none}.filters-container--open[data-jsx="1593199046"]{display:block;padding-bottom:20px}.product-item[data-jsx="1593199046"]{padding:5px}.empty-value[data-jsx="1593199046"]{height:200px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex:1;-ms-flex:1;flex:1;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.empty-value[data-jsx="1593199046"] h4[data-jsx="1593199046"]{font-size:17px;color:#039ED8}h4[data-jsx="1593199046"]{font-size:15px;color:#039ED8}.pagination-btn[data-jsx="1593199046"]{float:right;margin:0 40px 20px 0;color:#039ED8;font-size:20px}.pagination-btn[data-jsx="1593199046"] span[data-jsx="1593199046"]{display:block}@media (min-width:1024px){.products[data-jsx="1593199046"]{padding:40px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap}.filters[data-jsx="1593199046"]{display:initial;box-shadow:none;background:transparent}.filters-container[data-jsx="1593199046"]{display:block}.filters__toggle[data-jsx="1593199046"]{display:none}}'
				})
			);
		}
	}]);
...
var Product = function Product(_ref) {
	...
	return _react2.default.createElement(
		'div',
		{ className: 'product-container', 'data-jsx': 3644480108
		},
		_react2.default.createElement(
			'a',
			{ href: url.replace('#038;', '&'), className: 'product-item', style: { backgroundImage: 'url(' + thumb + ')' }, 'data-jsx': 3644480108
			},
			_react2.default.createElement('div', { className: 'product-img', style: { backgroundImage: 'url(' + thumb + ')' }, 'data-jsx': 3644480108
			}),
			_react2.default.createElement(
				'div',
				{ className: 'product__details', 'data-jsx': 3644480108
				},
				_react2.default.createElement(
					'span',
					{ className: 'product-name', 'data-jsx': 3644480108
					},
					name
				),
				_react2.default.createElement(
					'span',
					{ className: 'product-type', 'data-jsx': 3644480108
					},
					type
				),
				_react2.default.createElement(
					'span',
					{ className: 'product-subtype', 'data-jsx': 3644480108
					},
					subtype
				)
			)
		...
		_react2.default.createElement(_style2.default, {
			styleId: 3644480108,
			css: '.product-item[data-jsx="3644480108"]{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;position:relative;background-position:center;background-size:cover !important;min-height:260px;color:#5D5D5D;margin-bottom:30px}.product-container[data-jsx="3644480108"]{background:#fff}.product__details[data-jsx="3644480108"]{padding:20px;background:rgba(255,255,255,.8);position:absolute;width:100%;bottom:0;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;min-height:110px}.product-name[data-jsx="3644480108"]{font-size:19px;margin-bottom:20px;color:#039ED8}.product-type[data-jsx="3644480108"],.product-subtype[data-jsx="3644480108"]{font-size:15px;color:#039ED8}@media (min-width:1024px){.product-img[data-jsx="3644480108"]{display:none}}'
		})
	);
};
			...
			return _react2.default.createElement(
				...
				features.map(function (item) {
					return _react2.default.createElement(
						...
						_react2.default.createElement('img', { src: window.templateUri + '/public/img/' + item.name.toLowerCase().replace(' ', '_') + '.svg', alt: '', 'data-jsx': 2913832317
						}),
						' ',
						item.name
					);
				...
				_react2.default.createElement(_style2.default, {
					styleId: 2913832317,
					css: '.filter-type[data-jsx="2913832317"]{margin-bottom:20px}img[data-jsx="2913832317"]{padding:0 5px}'
				})
			);
		}
	}]);
