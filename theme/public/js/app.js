...
var ProjectsFilters = function (_Component) {
  ...
  function ProjectsFilters() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ProjectsFilters.__proto__ || Object.getPrototypeOf(ProjectsFilters)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.setState({ states: states }, function () {
...
var Product = function Product(_ref) {
	...
	return _react2.default.createElement(
		'div',
		{ className: 'product-container', 'data-jsx': 1287850791
		},
		_react2.default.createElement(
			'a',
			{ href: url.replace('#038;', '&'), className: 'product', style: { background: 'url(' + thumb + ') no-repeat' }, 'data-jsx': 1287850791
			},
			_react2.default.createElement(
				'div',
				{ className: 'product__details', 'data-jsx': 1287850791
				},
				_react2.default.createElement(
					'span',
					{ className: 'product-name', 'data-jsx': 1287850791
					},
					name
				),
				_react2.default.createElement(
					'span',
					{ className: 'product-type', 'data-jsx': 1287850791
					},
					type
				),
				_react2.default.createElement(
					'span',
					{ className: 'product-subtype', 'data-jsx': 1287850791
					},
					subtype
				)
			)
		...
		_react2.default.createElement(_style2.default, {
			styleId: 1287850791,
			css: '.product[data-jsx="1287850791"]{display:block;position:relative;background-size:cover !important;min-height:350px;color:#5D5D5D;margin-bottom:30px}.product-container[data-jsx="1287850791"]{background:#fff}.product__details[data-jsx="1287850791"]{padding:20px;background:rgba(255,255,255,.8);position:absolute;width:100%;bottom:0;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column}.product-name[data-jsx="1287850791"]{font-size:19px;margin-bottom:20px}.product-type[data-jsx="1287850791"],.product-subtype[data-jsx="1287850791"]{font-size:15px;color:#039ED8}'
		})
	);
};
